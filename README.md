...
![pairplot del primer dataset, comparando las columnas categoricas con el median_house_value](pairplotData1.png)
...
![grafico entre median_income y median_house_value con una linea trazada](pairplot2Data1.png)
...
![scatterplot de los valores predichos con una linea roja trazada](modelo1Data1.png)
...
![scatterplot de los valores predichos por el segundo modelo, tambien con una linea roja trazada](modelo2Data1.png)
...
![otro scatterplot comparando los valores predichos con una linea roja](modelo3Data1.png)
...
![pairplot comparando las variables del dataset con el house_price](pairplotData2.png)
...
![grafico scatterplot entre house_price y square_footage, con una linea recta trazada](pairplot2Data2.png)
...
![scatterplot comparando las predicciones del modelo con una linea roja](modelo1Data2.png)
...
![scatterplot demostrando las predicciones del segundo modelo](modelo2Data2.png)
...
![otro scatterplot mostrando el desempeño del tercer modelo](modelo3Data2.png)
